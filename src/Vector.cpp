...
void Vector2::SetX(float new_x) { x = new_x; }

void Vector2::SetY(float new_y) { y = new_y; }

float Vector2::GetLength() const { return sqrt(x * x + y * y); }
...
Vector2 Vector2::elByElMult(const Vector2& v2) const { return Vector2(x * v2.x, y * v2.y); }
